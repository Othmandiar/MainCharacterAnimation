...
//    }
    ...
    Vector3[] SpawnObjectsAroundCircleEvenly(int num, Transform point, float radius)
    {
    ...
    static float RemapRange(float input, float oldLow, float oldHigh, float newLow, float newHigh)
    {
